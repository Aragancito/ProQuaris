                    ...
                    <?php if (!empty($ordenes)): ?>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                ...
                                <a href="/ProQuaris/controllers/OrdenController.php?accion=eliminar&id=<?php echo $o['idOrden'] ?? ''; ?>" class="btn-action btn-delete" data-confirm="¿Eliminar esta orden?" title="Eliminar orden">
